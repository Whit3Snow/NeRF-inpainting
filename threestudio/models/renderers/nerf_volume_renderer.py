        ...
        **kwargs
        ...
        if self.cfg.estimator == "occgrid":
            if not self.cfg.grid_prune:
                ...
                if rays_o_flatten.nelement() == 0 or rays_d_flatten.nelement() == 0:
                    print("flatten is empty")
                    breakpoint()
                print("**************" * 5)
                print(rays_o_flatten)
                print("----------" * 5)
                print(rays_d_flatten)
                print("**************" * 5)
                ...
                with torch.no_grad():
                    ...
                    # breakpoint()
                    print("ray_indices:", ray_indices, "####"*6, "   : ", len(ray_indices))
        elif self.cfg.estimator == "proposal":
